        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-10 max-w-xl w-full shadow-2xl  ">
          <form onSubmit={handleSubmit(handleLogin)}>
            <div className="flex flex-col gap-6">
              <h1 className="text-center text-4xl font-bold bg-gradient-to-r from-rose-500 via-orange-400 to-yellow-500 text-transparent bg-clip-text drop-shadow-lg py-5">
                Login
              </h1>
